...
### Fixed
- Cancel workflow no longer crashes with Telegram Markdown parse error when path contains underscores

## [2026-04-10]

### Fixed
- Final merged invoice email now CCs invoicing department (was only sent to manager)
